#-------------------------------------------------------------------------------
# Name:        Explanation_1_13CMFA_toymodel.py
#              Python code to explain functions of mfapy
...
if __name__ == '__main__':
    ...
    #
    state_dic = model.load_states("Explanation_1_13CMFA_toymodel_status.csv", format = 'csv')
    """
    ...
    AcCoA	#11	0.5
    """
    cs2.set_carbonsources('Explanation_1_13CMFA_toymodel_carbonsource2.txt', correction = "no")
    #
    ...
    #
    mdv1.save("Explanation_1_13CMFA_toymodel_mdv1.txt", format = "text")
    #
    # Load MDV data from file
    #
    mdv3 = model.load_mdv_data("Explanation_1_13CMFA_toymodel_mdv1.txt", format = "text", output = "normal")
    #
    ...
    model.show_flux_balance(results, "Fum", filename = "Explanation_1_13CMFA_metabolite_balance.csv", format = "csv")# to file
    #
